---
title: Speed is a Leadership Issue
categories:
  - Leadership
tags:
  - systems
...
With "What that Looks Like" in hand, the next question is: What has to be true if the system is going to perform that way? You'll probably find a lot of these. Filter "New Truth"s for those within your influence. Then from those you can influence, focus on the bottleneck. [Every system has a bottleneck](https://en.wikipedia.org/wiki/Theory_of_constraints). Only by addressing the bottleneck can we improve the flow thru the system. 

Fixing a bottleneck will cause the system to shift. Let the system settle into it's new normal. Then repeat this process. Pick your target. Identify "New Truth"s. Filter, and focus. Then fix. Be a Leader who iterates. Speed is a Leadership issue. Own your work-system! Pick logical evolution, over hopeful insanity!
