...
This means effective empowerment looks different now. It's not just [enabling decisions when you're not in the room](/blog/on-effective-delegation/). It's enabling output creation when the specialist isn't in the room. New tools demand new systems and new ways of thinking. As [John Boyd](https://en.wikipedia.org/wiki/John_Boyd_(military_strategist)) taught us: People, Process, Technology in that order.
