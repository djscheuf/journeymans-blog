---
title: Structure Constrains Culture
categories:
...
I've even [tried to answer that](/blog/behaviors-build-culture/) in fact. From a individualistic perspective, it's about an individual's choice. Specifically, the team's culture is the product of the repeated choices of her members. If you want _'psychological safety'_, we have to behave in ways that make other humans feel it is safe. But this is not the whole story.
...
The Leader's job is not merely to identify good goals. It is also part of their work to [change the socio-technical system](https://itrevolution.com/articles/poor-social-circuitry-leads-to-the-danger-zone/) of our work. That is, changing the organization must be part of how they pursue new goals. Since our business challenges keep shifting, so should our culture and our structures.
