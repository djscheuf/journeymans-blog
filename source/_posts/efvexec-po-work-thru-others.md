...
Executives must also evolve their processes, capturing and codifying individual, local optimizations into more effective and systemic wholes. In [the first post of this series](./2024/08/07/efv-exec-po-evolve-process), I pointed out that this codifying of local optimizations is in effect the same as the work of the Effective Product Owner. In fact, there are several other overlaps between Drucker’s Effective Executive and an Effective Product Owner.
