...
Years ago, I wrote that [software developers are translators]([https://daniel.scheufler.tech/blog/software-developers-are-translators/](https://daniel.scheufler.tech/blog/software-developers-are-translators/)). We translated human intent into machine instructions. But I don't think that quite true anymore. AI has now compressed much of the labor in the translation effort. So what's left?
...
If you want to dive deeper into the frameworks that can help structure this work, check out the [BMAD method]([https://docs.bmad-method.org/](https://docs.bmad-method.org/)) or [ASDLC]([https://asdlc.io/](https://asdlc.io/)). I also touched on how you can lead your team in adopting these techniques this talk on [Technical Leadership in the Age of AI]([https://www.youtube.com/watch?v=VjYTGtolnE8&list=PL2I3mxniQ45SNCUKKM1_PrG84aY3eEm7H&index=1](https://www.youtube.com/watch?v=VjYTGtolnE8&list=PL2I3mxniQ45SNCUKKM1_PrG84aY3eEm7H&index=1))
